...
if (argument0 < 1) 
{
	return ((argument2 * 0.5 * argument0 * argument0 * argument0 * argument0 * argument0) + argument1);
}
argument0 -= 2;
return ((argument2 * 0.5* ((argument0 * argument0 * argument0 * argument0 * argument0) + 2)) + argument1);