...
{
	return ((argument[1] + argument[2] - ce_tween_back_out(argument[3] - argument[0] * 2, argument[1], argument[2], argument[3])) * 0.5) + (argument[1] * 0.5);
}

return (ce_tween_back_out(argument[0] * 2 - argument[3], argument[1], argument[2], argument[3]) * 0.5) + (argument[2] * 0.5);